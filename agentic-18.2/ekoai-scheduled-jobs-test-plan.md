...
|-------|-----------|----|----|-------|--------|------------|
| 1. Dashboard | 7 | 3 | 4 | 2 | 1 | 4 |
| 2. Create Scheduled Job | 12 | 6 | 6 | 5 | 1 | 6 |
| 3. Job Configuration | 10 | 6 | 4 | 4 | 1 | 5 |
| 4. Recipients (Audience) | 11 | 7 | 4 | 6 | 0 | 5 |
| 5. History Logs | 9 | 4 | 5 | 4 | 1 | 4 |
...
| **TOTAL** | **168** | **110** | **58** | **64** | **9** | **95** |

### Test Case Distribution
- **Positive (Smoke + Sanity)**: 73 cases (43%) — core happy paths
- **Negative + Edge (Regression)**: 95 cases (57%) — error handling, boundary, concurrency
- **All 168 titles** use "Check/Verify ... should ... when ..." style
